# PSOC&trade; Control C3M/P8: Free-running MCWDT

This code example explains how to set up a multi-counter watchdog timer (MCWDT) using the [MCWDT](https://infineon.github.io/mtb-pdl-cat1/pdl_api_reference_manual/html/group__group__mcwdt.html) PDL resource to measure the timing between events in free-running mode on PSOC&trade; Control C3M/P8 MCU.
...
[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce241629-mcwdt)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[mtb-example-ce241629-mcwdt](https://github.com/Infineon/mtb-example-ce241629-mcwdt)" application with the desired name "MCWDT" configured for the *KIT_PSC3M8_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC3M8_EVK --app-id mtb-example-ce241629-mcwdt --user-app-name MCWDT --target-dir "C:/mtb_projects"
   ```
...
**Table 1. Application resources**
 ...
 UART       | DEBUG_UART_HW           | retarget-io UART HAL object used for debug UART port
...
Document title: *CE241629* – *PSOC&trade; Control C3M/P8: Free-running MCWDT*
